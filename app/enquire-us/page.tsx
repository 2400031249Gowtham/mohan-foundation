              ...
              <div className="relative z-10 mt-12 pt-8 border-t border-white/10">
                ...
                <div className="flex gap-3">
                  {[Globe, Share2, Users, ExternalLink].map((Icon, i) => (
                    <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#10B981] hover:-translate-y-1 flex items-center justify-center transition-all duration-300">
                      <Icon size={16} />
                    </a>
                  ))}
                </div>
