  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-[120px] pb-24 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-10 md:p-16 border border-gray-100">
        <h1 className="text-4xl font-extrabold text-[#1a2744] mb-8 border-b pb-6">Terms & Conditions</h1>
        
        <div className="prose prose-gray max-w-none text-gray-600 mb-12">
          <p className="mb-4">
            This Terms & Conditions document is currently being updated. Please check back later for the complete terms regarding the use of MOHAN Foundation's services and portal.
          </p>
          <p>
