          ...
          <div className="mt-12">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={i} href={href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#d3222a] flex items-center justify-center transition-colors">
                  <Icon size={18} />
                </a>
              ))}
            </div>
