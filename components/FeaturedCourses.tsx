...
const CourseCard = ({ course, isActive, isDesktop }: { course: Course, isActive: boolean, isDesktop: boolean }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 
          className="font-bold md:text-[1.15rem] text-xl md:leading-[1.3] leading-tight text-mf-dark mb-1 transition-all duration-500 flex items-start pointer-events-none"
        ...
        <div 
          className="text-mf-dark font-medium text-[0.85rem] mb-3 transition-all duration-500 pointer-events-none"
        ...
        <div 
          className="flex items-center justify-between bg-black/5 rounded-[8px] px-4 py-2.5 mb-3 transition-all duration-500 pointer-events-none"
          style={{ transform: isActive && isDesktop ? "translateZ(15px)" : "translateZ(0px)" }}
        >
        ...
        <p 
          className="text-[0.85rem] text-mf-mid line-clamp-2 mb-4 transition-all duration-500 pointer-events-none flex-grow"
          style={{ transform: isActive && isDesktop ? "translateZ(15px)" : "translateZ(0px)" }}
        >
          {course.description}
        </p>
        ...
        {/* Bottom Bar */}
        <div 
          className="mt-auto flex items-center justify-center transition-all duration-500 pt-2"
        ...
        >
          <Link 
            ...
            className="inline-flex justify-center items-center bg-[#1E1B7A] hover:bg-[#15125A] hover:scale-[1.02] text-white px-8 py-3 rounded-full text-[0.9rem] font-bold transition-all duration-300 pointer-events-auto relative z-[100]"
          >
            Register Now
          </Link>
        </div>
...
export default function FeaturedCourses() {
  ...
  return (
    <section id="courses" className="py-10 md:py-12 bg-mf-cream relative overflow-hidden font-sans">
      ...
      <div className="max-w-[1440px] mx-auto px-0 md:px-8 relative z-10">
        ...
        <motion.div 
          ...
          className="text-center mb-6 flex flex-col items-center px-4"
        >
