...
const professionalCourses: Record<string, Course> = {
  '3': {
    id: '3',
    category: '#Transplant Coordination',
    shortTitle: 'Transplant Cert.',
    title: 'Transplant Coordination Professional Certificate',
    activeClass: 'border-[#3b82f6] shadow-[0_0_30px_rgba(59,130,246,0.4)]',
    color: '#00F0FF',
    icon: Building,
    lessons: '40 Lessons',
    duration: '6 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/hospital.png'
  },
  '4': {
    id: '4',
    category: '#PG Diploma',
    ...
    activeClass: 'border-[#a855f7] shadow-[0_0_30px_rgba(168,85,247,0.4)]',
    color: '#B000FF',
    icon: Award,
    lessons: '52 Lessons',
    duration: '52 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/diploma.png'
  },
  '5': {
    id: '5',
    category: '#Medical Professionals',
    shortTitle: 'Brainstem Death',
    title: 'Brainstem Death – Identification, Certification and Donor Optimization',
    activeClass: 'border-[#eab308] shadow-[0_0_30px_rgba(234,179,8,0.4)]',
    color: '#FFEA00',
    icon: Brain,
    lessons: '20 Lessons',
    duration: '3 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/brain.png'
  },
  '6': {
    id: '6',
    category: '#Medical Professionals',
    shortTitle: 'Medical Course',
    title: 'Essential Course On Organ Donation For Medical Professionals',
    activeClass: 'border-[#10b981] shadow-[0_0_30px_rgba(16,185,129,0.4)]',
    color: '#10b981',
    icon: Stethoscope,
    lessons: '20 Lessons',
    duration: '3 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/stethoscope.png'
  },
  '7': {
    id: '7',
    ...
    activeClass: 'border-[#06b6d4] shadow-[0_0_30px_rgba(6,182,212,0.4)]',
    color: '#06b6d4',
    icon: Activity,
    lessons: '20 Lessons',
    duration: '3 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/ambulance.png'
  },
  '2': {
    id: '2',
    category: '#Legal Aspects',
    shortTitle: 'Legal Laws',
    title: 'Understanding Organ Donation Laws',
    activeClass: 'border-[#f43f5e] shadow-[0_0_30px_rgba(244,63,94,0.4)]',
    color: '#f43f5e',
    icon: Scale,
    lessons: '20 Lessons',
    duration: '3 Weeks',
    ...
    iconUrl: 'https://img.icons8.com/color/240/law.png'
  }
};
...
const publicCourses: Record<string, Course> = {
  '9': {
    ...
    iconUrl: 'https://img.icons8.com/color/240/gift.png'
  },
  '13': {
    id: '13',
    category: '#Hindi',
    ...
    iconUrl: 'https://img.icons8.com/color/240/volunteering.png'
  },
  '10': {
    id: '10',
    ...
    iconUrl: 'https://img.icons8.com/color/240/kidney.png'
  },
  '11': {
    id: '11',
    category: '#Health & Wellness',
    ...
    iconUrl: 'https://img.icons8.com/color/240/liver.png'
  },
  '12': {
    id: '12',
    category: '#Health & Wellness',
    ...
    iconUrl: 'https://img.icons8.com/color/240/lungs.png'
  }
};
...
export default function KnowledgeEcosystem() {
  ...
  return (
    <section id="ecosystem" className="relative w-full overflow-hidden bg-[#FDFBF7] py-10 lg:py-16">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 pt-6 pb-2 max-w-4xl mx-auto">
        {/* Top Pill */}
        <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-[#E2E8F0] bg-white text-[#1E3A8A] text-[11px] font-bold tracking-widest uppercase mb-8 shadow-sm">
          Our Courses
        </div>
        
        {/* Title */}
        <h1 className="text-4xl lg:text-[3.5rem] font-serif font-bold text-slate-900 leading-tight mb-4">
          Our Featured <br />
        ...
        {/* Subtitle */}
        <p className="max-w-2xl text-[1.05rem] text-slate-600 font-medium leading-relaxed mb-6">
        ...
        <div className="hidden lg:flex w-full lg:w-1/3 justify-center z-30 pb-12 lg:pb-0 relative mt-[400px] lg:mt-0">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="p-8 pt-8 flex flex-col flex-grow">
                <h2 className="text-xl lg:text-[1.4rem] font-serif font-bold mb-6 leading-snug text-slate-900">
                  {activeCourse.title}
                </h2>

                <div className="flex items-center space-x-6 mb-5 text-slate-600 font-medium">
